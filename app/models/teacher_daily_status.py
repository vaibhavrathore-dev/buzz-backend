...
from sqlalchemy import Boolean, Date, ForeignKey,func, Text, Uuid, UniqueConstraint
...
class TeacherDailyStatus(Base):
    ...
    teacher_daily_status_id: Mapped[UUID] = mapped_column(Uuid, primary_key=True,server_default=func.gen_random_uuid())
